...
export type Query = {
  __typename?: "Query";
  failIfNonPremiumUserHasReachedMaxRequestsCount: Scalars["Boolean"];
...
export type CheckUrlLaunchedManuallyQuery = {
  __typename?: "Query";
  checkUrlLaunchedManually: {
    __typename?: "RequestResult";
    id: string;
    createdAt: any;
    url: string;
...
export type CheckIfNonPremiumUserHasReachedMaxRequestsCountQuery = {
  __typename?: "Query";
  failIfNonPremiumUserHasReachedMaxRequestsCount: boolean;
};
...
export type UpdateRequestSettingMutation = {
  __typename?: "Mutation";
...
export type GetRequestSettingByIdQuery = {
  __typename?: "Query";
...
export type GetPageOfRequestSettingWithLastResultQuery = {
  ...
  getPageOfRequestSettingWithLastResult: {
    ...
    requestSettingsWithLastResult: Array<{
      __typename?: "RequestSettingWithLastResult";
      requestSetting: {
        __typename?: "RequestSetting";
        id: string;
...
export const CheckUrlLaunchedManuallyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CheckUrlLaunchedManually" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "checkUrlLaunchedManuallyId" },
          },
          type: {
            kind: "NonNullType",
            type: {
  ...
  CheckUrlLaunchedManuallyQueryVariables
>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "deleteRequestSetting" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "requestId" },
        ...
        selections: [
          {
            ...
            name: {
              kind: "Name",
              value: "failIfNonPremiumUserHasReachedMaxRequestsCount",
            },
          },
        ],
      },
...
>;
export const UpdateRequestSettingDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "updateRequestSettingId" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
>;
export const GetRequestSettingByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetRequestSettingById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "requestSetting" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
...
>;
export const GetPageOfRequestSettingWithLastResultDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetPageOfRequestSettingWithLastResult" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            name: {
              kind: "Name",
              value: "getPageOfRequestSettingWithLastResult",
            },
            arguments: [
              {
                kind: "Argument",
            ...
            selectionSet: {
              ...
              selections: [
                ...
                },
                {
                  ...
                  name: {
                    kind: "Name",
                    value: "requestSettingsWithLastResult",
                  },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
