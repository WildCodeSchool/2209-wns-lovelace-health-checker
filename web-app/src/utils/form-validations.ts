...
// Firstname
export const FIRSTNAME_IS_REQUIRED_ERROR_MESSAGE = "First name is required";
...
export const LASTNAME_PLACEHOLDER = "Doe";

// Password
export const PASSWORD_IS_REQUIRED_ERROR_MESSAGE = "Password is required";
